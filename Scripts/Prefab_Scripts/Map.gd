...
var itemSpawnLocations = {
	...
	ResourceManager.Resource.STONE: [TILETYPE.BASE, TILETYPE.GRASS, TILETYPE.FOREST, TILETYPE.CAVE],
	ResourceManager.Resource.WOOD: [TILETYPE.BASE, TILETYPE.GRASS, TILETYPE.FOREST, TILETYPE.CAVE]
}
...
func spawn_goblin():
	...
	newGoblin.call_deferred("start_specific_job", "wander")
